            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 ">
                    <div class="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-20 px-10 sm:px-12 md:px-[60px]">
                        <div class="flex flex-col pb-3 text-2xl font-semibold">
                            <span>Hey,</span><span>Register Here</span>
                        </div>
                        <form action="?page=createuser" method="post">
                                ...
                                <div class="block w-full"><label>
                                    <div class="flex items-center rounded-md border text-base font-medium text-white border-primary-100">
                                        <div class="grow"><span
                                                ...
                                                name="userfullname"><div class="absolute right-3"></div></span></div>
                                    </div>
                                </label></div>
                                <div class="block w-full"><label>
                                    <div class="flex items-center rounded-md border text-base font-medium text-white border-primary-100">
                                        <div class="grow"><span
                                                ...
                                                class="md:text-md block w-full appearance-none rounded-md border-0 px-3 text-sm font-medium text-black placeholder-gray-500 focus:outline-none focus:ring-0 pl-3 h-12"
                                                name="email"><div class="absolute right-3"></div></span></div>
                                    </div>
                                </label></div>
                                <div class="block w-full"><label>
                                    <div class="flex items-center rounded-md border text-base font-medium text-white border-primary-100">
                            ...
                            <p class="md:text-md mt-3 text-sm">Already have an account?<a
                                    class="mx-1 text-primary-500 underline hover:underline"
                                    href="login?page=login">Login</a>
                            </p>
                            <c:if test="${error != null}">
                                <div class="md:text-md flex flex-col gap-4 pt-2 text-xs"><p class="text-red-500">
                                        ${error}
                                </p></div>
                            </c:if>
                            <c:if test="${success != null}">
                                <div class="md:text-md flex flex-col gap-4 pt-2 text-xs"><p class="text-green-500">
                                        ${success}
                                </p></div>
                            </c:if>
                            <button type="submit"
